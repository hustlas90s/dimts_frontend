        ...
        <div className="relative flexCenteredContainer overflow-hidden bg-login bg-cover bg-center">
            ...
            <div className="z-10 relative card bg-white w-[950px] h-[650px] grid grid-cols-2 rounded-xl">
                <div className="absolute left-5 flex gap-x-1 pt-10 pb-5 px-5">
                    ...
                    <h4 className="text-xl text-purple-600 font-black tracking-widest">Dimts</h4>
                </div>
                {/*  */}
                <div className="flex flex-col justify-center items-center gap-y-8">
                    ...
                    <div className="flex flex-col gap-y-3">
                        ...
                        <div className="flex text-sm gap-x-1">
                            <p>Not registered?</p> 
                            <Link href="/register">
                                <span className="text-purple-600 font-medium cursor-pointer">Create Account</span>
                            </Link>
                        </div>
                    </div>
                    <PrimaryButton 
                ...
                {/*  */}
                <div className="bg-login bg-cover bg-center rounded-tr-xl rounded-br-xl">
