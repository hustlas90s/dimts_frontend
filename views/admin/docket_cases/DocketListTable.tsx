                        ...
                        docketList.map((docket: any) => {
                            return (
                                <tr className="border-b border-gray-200 hover:bg-gray-50">
                                    <td className="py-3 px-6 text-left whitespace-nowrap">{ docket.case_no }</td>
                                    <td className="py-3 px-6 text-left whitespace-nowrap">{ docket.type_of_case } Case</td>
                                    <td className="py-3 px-6 text-left whitespace-nowrap">{ docket.judge_assigned }</td>
                                    <td className="py-3 px-6 text-left whitespace-nowrap">{ docket.case_status }</td>
