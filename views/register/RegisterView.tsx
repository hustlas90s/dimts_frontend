...
const RegisterView = () => {
    ...
    return (
        <div className="relative flexCenteredContainer overflow-hidden bg-register bg-cover bg-center">
            {/*  */}
            <div className="absolute w-full h-screen bg-indigo-300 opacity-70">
            ...
            <div className="z-10 card bg-white w-[950px] h-[650px] grid grid-cols-2 rounded-xl">
                ...
                <div className="relative bg-register bg-cover bg-center rounded-tl-xl rounded-bl-xl">
                    <div className="absolute left-5 flex gap-x-1 pt-10 pb-5 px-5">
                        ...
                        <h4 className="text-xl text-white font-black tracking-widest drop-shadow">Dimts</h4>
                    </div>
                </div>
                {/*  */}
                <div className="flex flex-col justify-center items-center gap-y-8">
                    <div className="flex flex-col gap-y-1 items-center">
                        ...
                        <div className="mt-3 w-64 flex justify-between">
                            ...
                            {/*  */}
                            <div className="flex flex-col items-center gap-y-1">
                                <div className={`${ currentStep > 0 ? 'bg-purple-600' : 'bg-gray-300' } w-8 h-8 rounded-full flex justify-center items-center`}>
                                    <svg 
                                        xmlns="http://www.w3.org/2000/svg" 
                                        viewBox="0 0 20 20" 
                                        fill="currentColor" 
                            ...
                            {/*  */}
                            <div className="flex flex-col items-center gap-y-1">
                            <div className={`${ currentStep > 1 ? 'bg-purple-600' : 'bg-gray-300' } w-8 h-8 rounded-full flex justify-center items-center`}>
                                    <svg 
                                        xmlns="http://www.w3.org/2000/svg" 
                                        viewBox="0 0 20 20" 
                                        fill="currentColor" 
                    ...
                    <div className="flex gap-x-1">
                        ...
                        <p className="text-sm font-semibold text-purple-500">{ currentStep + 1 }</p>
