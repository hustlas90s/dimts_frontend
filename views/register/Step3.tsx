...
import { onSubmitRegisterStep3, registerAccount, clearRegisterState } from "../../redux/authSlice"
import { useRouter } from "next/router"

const Step3 = () => {

    const dispatch = useAppDispatch()
    const { registerUsername, registerPassword } = useAppSelector((state: any) => state.authState)
